...
export const MESSAGES = [
  ...
  'Лицо, когда узнаешь, что понедельник уже завтра',
  'Мне нужен такой же дружок',
  'Кто-то здесь любит покушать',
  'Вот это я понимаю, комфортное место для отдыха',
  'Как же я люблю лето!',
  'Это не просто фото, это искусство',
  'Когда смотришь на свои расходы в конце месяца',
  'Однажды на Диком Западе...',
  'Это не мое прекрасное утро',
  'Ну и куда же мы пойдем сегодня?'
];
